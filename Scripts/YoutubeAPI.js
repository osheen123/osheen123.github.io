...
var baseAPI='https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=12&playlistId=PLDxO0t2Gkko-nZivNhrmYjZhZ6lM5NX6A&key=';

var pageToken="0";
var scrolltokenarray=[]

$(document).ready(function(){   
    var decr = CryptoJS.AES.decrypt("U2FsdGVkX18vQzeA1Yhsg7o96VtE3dR0N4497TX9ofbARgskx4nkObUHdQ+NxdN3kXGs8wmggUOH5Jq8ZTaz1w==", "OSHEENMUSIC").toString(CryptoJS.enc.Utf8);     
    baseAPI+=decr
    YoutubeAPI();       
});
